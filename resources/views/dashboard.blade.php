                            ...
                            <div class="row">
                                                    ...
                                                    <div class="kt-widget17__stats">
                                                        <div class="kt-widget17__items">
                                                            <div class="kt-widget17__item">
                                                                ...
                                                                Total Aviation Sectors
                                                                </span> 
                                                                <span class="kt-widget17__desc">
                                                                Working on 72 Sectors
                                                                </span>  
                                                            </div>
                                                            <div class="kt-widget17__item">
                                                                <span class="kt-widget17__icon">
                                                                ...
                                                                <span class="kt-widget17__desc">
                                                                211 Flights From 11+ Airline Carriers
                                                                </span>  
                                                            </div>
                                                        </div>
                                                        <div class="kt-widget17__items">
                                                            <div class="kt-widget17__item">
                                                                ...
                                                                <span class="kt-widget17__subtitle">
                                                                Upcomming Departures
                                                                </span> 
                                                                <span class="kt-widget17__desc">
                                                                17 Upcomming FD's & Deals
                                                                </span>  
                                                            </div>
                                                            <div class="kt-widget17__item">
                                                                <span class="kt-widget17__icon">
                                ...
                                <div class="col-lg-4 col-xl-4 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet">
                                        <div class="kt-portlet__head kt-portlet__space-x">
                                            ...
                                            <div class="kt-portlet__head-toolbar">
                                                <a href="" class="btn btn-label-warning btn-sm  btn-bold dropdown-toggle" style="background-color:black" data-toggle="dropdown">
                                                VIEW FD's
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-widget20">
                                            <div class="kt-widget20__content kt-portlet__space-x">
                                                <span class="kt-widget20__number kt-font-brand">DEL-DXB-DEL (Delhi-Dubai)</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet">
                                        ...
                                        <div class="kt-widget20">
                                            <div class="kt-widget20__content kt-portlet__space-x">
                                                <span class="kt-widget20__number kt-font-danger">MALE (Ex - DEL,BOM,AMD)</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet">
                                        ...
                                        <div class="kt-widget20">
                                            <div class="kt-widget20__content kt-portlet__space-x">
                                                <span class="kt-widget20__number kt-font-danger">BLR-PAT, IXC-GOA</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                        <a href="http://b2bfixeddepartures.com/international-fd">
                                            <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                                <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(./img/Air-Canada-B2B-Fixed-Departures.jpg)">
                                                    <h3 class="kt-widget19__title kt-font-light">
                                                        Canada Direct Flights (Ex DEL)
                                                    </h3>
                                                    <div class="kt-widget19__shadow"></div>
                                                    <div class="kt-widget19__labels">
                                        <a href="http://b2bfixeddepartures.com/domestic-fd" class="btn btn-label-light-o2 btn-bold ">TRENDING</a>
                                        </div>
                                        </div>
                                        </div>
                                        </a>
                                        <div class="kt-portlet__body">
                                            <div class="kt-widget19__wrapper">
                                                <div class="kt-widget19__text">
                                                    Delhi to Canada, Toronto, Vancouver, Calgary, Direct & 1 Stop Flights Air Canada & Air India Now Available From 1st Nov
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                        <a href="http://b2bfixeddepartures.com/domestic-fd">
                                            <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                                <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(./img/andaman-fixed-departure-by-b2b-fixed-departures.jpg)">
                                                    <h3 class="kt-widget19__title kt-font-light">
                                                        Andaman Fixed Depatures
                                                    </h3>
                                                    <div class="kt-widget19__shadow"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-widget19__wrapper">
                                                <div class="kt-widget19__text">
                                                    Travel to Andaman, With Daily Available Fixed Departures From More Than 5+ Metropolitan Cities of India.  
                                                </div>
                                            </div>
                                        </div>
                                    </div>
