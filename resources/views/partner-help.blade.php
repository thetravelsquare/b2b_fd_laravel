...
<!-- begin:: Content -->
                        <!-- begin:: Hero -->
                        <div class="kt-sc" >
                            <div class="kt-container " style="height:400px;background-image: url(http://partner.thetravelsquare.in/resource/admin/img/partner-help-the-travel-square-business-platform.jpg)">
                        ...
                        <div class="kt-container " style="margin-top:50px;">
                            <div class="row">
                                <div class="col-lg-4">
                                    <a href="tel:8595902759" class="kt-portlet kt-iconbox kt-iconbox--animate-slow">
                                ...
                                <div class="col-lg-4">
                                    <a href="mailto:care@fixeddeparturesflights.com" class="kt-portlet kt-iconbox kt-iconbox--animate">
                                        <div class="kt-portlet__body">
                                            <div class="kt-iconbox__body">
                                                <div class="kt-iconbox__icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                ...
                                                <div class="kt-iconbox__desc">
                                                    ...
                                                    <div class="kt-iconbox__content">
                                                        care@fixeddeparturesflights.com
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4">
                                    <a href="https://www.google.com/maps/dir/28.6795011,77.2832967/BIMTECH+-+Birla+Institute+of+Management+Technology,+Plot+Number+5,+Knowledge+Park+2,+NCR,+Greater+Noida,+Uttar+Pradesh+201306,+India/@28.5637325,77.2264768,11z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x390cc1ddbcb1ef8b:0xf6fc0a3d2855d53c!2m2!1d77.4947516!2d28.4581066	" class="kt-portlet kt-iconbox kt-iconbox--animate-fast">
                                        <div class="kt-portlet__body">
                                            <div class="kt-iconbox__body">
                                                <div class="kt-iconbox__icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-infobox">
                                        <div class="kt-infobox__header">
                                            <h2 class="kt-infobox__title">B2B Fixed Departures</h2>
                                        </div>
                                        <div class="kt-infobox__body">
                                            <div class="kt-infobox__section">
                                                <h3 class="kt-infobox__subtitle">About Company</h3>
                                                <div class="kt-infobox__content">
                                                    B2B Fixed Departures (TM) Detroit Blacbird Aviations Private Limited is an Aviation Hositality Service Company 
                                            ...
                                            <div class="kt-infobox__section">
                                                ...
                                                <div class="kt-infobox__content">
                                                    ...
                                                    <a href="" class="kt-link">care@fixeddeparturesflights.com</a>.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-callout__body">
                                                ...
                                                <div class="kt-callout__action">
                                                    <a href="mailto:care@fixeddeparturesflights.com" class="btn btn-custom btn-bold btn-upper btn-font-sm btn-primary">Submit Request</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet kt-callout">
                                        <div class="kt-portlet__body">
                                            <div class="kt-callout__body">
                                                ...
                                                <div class="kt-callout__action">
                                                    <a href="mailto:sales@b2bfixeddepartures.com" class="btn btn-custom btn-bold btn-upper btn-font-sm  btn-success">Submit Request</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
