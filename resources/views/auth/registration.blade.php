...
<title>Partner Registration | Onboarding | B2B Fixed Departures Flight | World's Largest Fixed Departure Aggregators | b2bfixeddepartures.com</title>


<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="author" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
...
<meta name="copyright" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
<meta name="revisit-after" content="1 Second">
<meta name="designer" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
<meta name="language" content="english">
<meta name="robots" content="index, follow">
<meta name="rating" content="general">
<meta name="publisher" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">

<meta property="og:title" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
...
<meta name="twitter:title" content="Partner Registration | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
			...
			<div
				...
				<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside"
					...
					<div class="kt-grid__item">
						<a href="" class="kt-login__logo">
							<img src="./img/b2b-fixed-departure-logo-symbol.png" width="112" height="75">
						</a>
					</div>
				...
				<div
					...
					<div class="kt-login__head">
						...
						<a href="http://b2bfixeddepartures.com/partner-login" class="kt-link kt-login__signup-link">Sign In</a>
					</div>
					<!--end::Head-->
					...
					<div class="kt-login__body">
						...
						<div class="kt-login__form">
							...
							<form action="{{ route('register.post') }}" class="kt-form" id="kt_login_form" method="post" accept-charset="utf-8">
								@csrf
							<!-- <form class="kt-form" action="http://partner.thetravelsquare.in/partner/login" novalidate="novalidate" id="kt_login_form"> -->
								...
								<div class="form-group">
									<input class="form-control" type="text" placeholder="Account Manager Name" name="ac_manager_name"
										autocomplete="off">
								</div>
								<div class="form-group">
									<input class="form-control" type="text" placeholder="Company Mail ID" name="company_mail_id"
										autocomplete="off">
								</div>
								<div class="form-group">
								...
								<div class="kt-login__actions">
									...
									<button id="kt_login_signin_submit"
										class="btn btn-primary btn-elevate kt-login__btn-primary" style="background-color:black">SIGN UP</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
