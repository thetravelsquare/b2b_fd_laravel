...
<title>Partner Login | B2B Fixed Departures Flight | World's Largest Fixed Departure Aggregators | b2bfixeddepartures.com</title>


<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="author" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
...
<meta name="copyright" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
<meta name="revisit-after" content="1 Second">
<meta name="designer" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
<meta name="language" content="english">
<meta name="robots" content="index, follow">
<meta name="rating" content="general">
<meta name="publisher" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">

<meta property="og:title" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
...
<meta name="twitter:title" content="Partner Login | B2B Fixed Departures | World's Largest Fixed Departure Aggregators">
...
<script async="" src="http://partner.thetravelsquare.in/resource/admin/files/modules.3a2c212c6000288ee2ae.js" charset="utf-8"></script>
<style type="text/css">
...
</style><script type="text/javascript" charset="UTF-8" src="{{ asset('files/common.js') }}"></script><script type="text/javascript" charset="UTF-8" src="http://partner.thetravelsquare.in/resource/admin/files/util.js"></script></head>
<!-- end::Head -->

<!-- begin::Body -->

<body style="background-image: url(http://partner.thetravelsquare.in/resource/admin/img/partner-login-the-travel-square.jpg)"
		...
		<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v1" id="kt_login">
			<div
				...
				<div class="kt-grid__item kt-grid__item--order-tablet-and-mobile-2 kt-grid kt-grid--hor kt-login__aside"
					style="background-image: url(http://partner.thetravelsquare.in/resource/admin/metronic/themes/metronic/theme/default/demo8/dist/assets/media/bg/bg-4.jpg);">
					<div class="kt-grid__item">
						<a href="" class="kt-login__logo">
							<img src="{{ asset('img/b2b-fixed-departure-logo-symbol.png') }}" width="112" height="75">
						</a>
					</div>
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
						<div class="kt-grid__item kt-grid__item--middle">
							<h2 class="kt-login__title">b2bfixeddepartures.com</h2>
							<h4 class="kt-login__subtitle">Welcome to B2B Fixed Departure Platform, Worlds's
								Largest Fixed Departure, Pre-Purchased Flight Aggregators !</h4>
						</div>
					</div>
					<div class="kt-grid__item">
				...
				<div
					...
					<div class="kt-login__head">
						...
						<a href="{{ route('register') }}" class="kt-link kt-login__signup-link">Register Now</a>
					</div>
					<!--end::Head-->
					...
					<div class="kt-login__body">
						...
						<div class="kt-login__form">
							...
							<form action="{{ route('login') }}" class="kt-form" id="kt_login_form" method="post" accept-charset="utf-8">
                            @csrf
							<!-- <form class="kt-form" action="http://partner.thetravelsquare.in/partner/login" novalidate="novalidate" id="kt_login_form"> -->
								...
								<div class="kt-login__actions">
									<a href="http://b2bfixeddepartures.com/forgot-password" class="kt-link kt-login__link-forgot">
										Forgot Password ?
									</a>
									<button id="kt_login_signin_submit"
										class="btn btn-primary btn-elevate kt-login__btn-primary" style="background-color:black">LOGIN</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
