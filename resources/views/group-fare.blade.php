                                                ...
                                                <div class="kt-section kt-section--first">
													...
													<div class="form-group">
														...
														<select class="custom-select form-control">
															...
															<option value="2">Return Type</option>
														</select>
													</div>
                                                    ...
                                                    <div class="form-group row">
														...
														<div class="col-6">
															<input class="form-control" type="datetime-local" value="2021-12-25T10:20:00" id="example-datetime-local-input" />
														</div>
													</div>
													<div class="form-group row">
														<label for="example-datetime-local-input" class="col-2 col-form-label">Arrival Date</label>
														<div class="col-6">
															<input class="form-control" type="datetime-local" value="2021-12-30T13:30:00" id="example-datetime-local-input" />
														</div>
													</div>
													<div class="form-group row">
